...
public class MyPuzzleGame extends ApplicationAdapter {
	SpriteBatch batch;
	Texture numeros[],background,start,gano, play, mezclar;
	int puzzle[][];
	int clicks=0;
	BitmapFont font;
	...
	public void create () {
		...
		start = new Texture("empezar.png");
		play = new Texture("reset.png");
		gano = new Texture("gano.png");
		mezclar = new Texture("random.png");
		puzzle = new int [3][3];
		font = new BitmapFont();
	...
	public void render () {
		...
		if (inicio){
			batch.draw(background,0,15);
			batch.draw(start,275,125);
